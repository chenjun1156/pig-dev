...
<template>
  <view class="container">
   ...
   <view class="details">
   <view class="details_title">{{buyerInfo.address+"求购"+buyerInfo.pig_type_name+buyerInfo.nums+"头"}}</view>
   ...
   <view class="details_content">
       ...
       <text>数量：{{buyerInfo.nums}}头</text>
        <text>价格：{{buyerInfo.price}}元/斤</text>
         <text>求购时间：{{buyerInfo.buy_time}}</text>
...
export default class PigDetails extends wepy.page {
  config = {
