   ...
   <form bindsubmit='submit'>
      ...
      <image class="icon_down" src="../../images/down@2x.png" />
       ...
       <view class="text_content">
        ...
        <button class="submit" formType='submit' disabled="{{isBan}}">修改保存</button>
   </form>
</view>
</template>
...
export default class EditJobs extends wepy.page {
  config = {
    navigationBarTitleText: "修改求职"
  };
  data = {
    jobType:[],//工种
    city: [],//选择地区
